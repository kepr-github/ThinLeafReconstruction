%% Cleanup & load data from PLY
% close all to keep optional
close all

% Specify the PLY file to process
plyFilename = 'scan.ply'; % <-- change this filename

[pc, ~] = readCustomPly(plyFilename);
...
% Downsampling
method = 'gridaverage';
downsampleParam = 1.5; % grid size or proportion
